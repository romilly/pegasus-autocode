...
class AutocodeLineParser(runtime.Parser):
    ...
    def index_assignment(self, _parent=None):
        ...
        _token = self._peek('tapes', 'negate', 'mod', "'v'", 'INDEX', 'INT', context=_context)
        if _token == 'tapes':
            tape_spec = self.tape_spec(_context)
        else: # in ['negate', 'mod', "'v'", 'INDEX', 'INT']
    ...
    def tape_spec(self, _parent=None):
        ...
        if self._peek('star', 'INDEX', 'rparen', 'gets', "','", 'div', 'op', 'plus', 'compare', 'EOL', context=_context) in ['star', 'INDEX']:
    ...
    def int_expression(self, _parent=None):
        ...
        _token = self._peek('negate', 'mod', "'v'", 'INDEX', 'INT', context=_context)
        if _token == 'INDEX':
            is_op = False
            index = self.index(_context)
            if self._peek('op', 'star', 'gets', 'rparen', "','", 'plus', 'compare', 'div', 'EOL', context=_context) in ['op', 'star']:
