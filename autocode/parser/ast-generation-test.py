...
from autocode.parser.ast import Integer, Index, Modifier, IndexAssignment, Plus
...
class AstGenerationTest(unittest.TestCase):
    ...
    #     self.assertEqual(autocode_line.parse('modifier','(5 + n2)'), Modifier(None, Integer(5), Index('n2')))
